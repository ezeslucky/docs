...
description: A guide to authenticating with the Deployi CLI
---
...
1. `deployi authenticate` - Authenticate with the Deployi CLI.
2. `deployi verify` - Verify if the access token is valid.
