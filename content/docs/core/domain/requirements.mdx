---
title: "Requirements"
description: "See a requirements for a domain for the Deployi panel"
---

This guide will give you an idea of the requirements to assign a domain to your Deployi panel or use it in any other application, whether Docker Compose or otherwise.
