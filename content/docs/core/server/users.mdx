---
title: Users
description: 'Manage user roles and permissions within Deployi. Admin roles are limited to one per instance.'
---
import { Callout } from 'fumadocs-ui/components/callout';

Manage user roles and permissions within Deployi. Note that only one admin role is allowed per instance.

## Permissions

Deployi offers multiple permissions to manage your users effectively:
