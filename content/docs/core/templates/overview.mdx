---
title: Templates
description: Deploy open source templates with Deployi
---
...
We accept contributions to upload new templates to the deployi repository.

Make sure to follow the guidelines for creating a template:

[Steps to create your own template](https://github.com/ezeslucky/deployi/blob/canary/CONTRIBUTING.md#templates)