...
Deployi offers several deployment methods, streamlining the process whether you're utilizing GitHub, any Git provider, Docker, or automated deployments.
...
2. When creating an application, Deployi automatically retrieves the available repositories and branches.
