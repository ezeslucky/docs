...
This section outlines how to configure domains for your applications in Deployi, ensuring that your applications are accessible via custom URLs.
...
- **Host**: The domain name that you want to link to your application (e.g., `api.deployi.me`).
...
- **Certificate**: Select whether to secure the domain with SSL/TLS certificates. Deployi supports automatic provisioning of SSL certificates via Let's Encrypt.
